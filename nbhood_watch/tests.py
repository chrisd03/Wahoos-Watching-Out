...
class SubmissionWithGoogleMap(TestCase):

    def test_submission_creation(self):
        self.submission = Submission.objects.create(submission_title='Yo this is my submission',
                                                    submission_visibility='Public',
                                                    submission_verification='Unverified',
                                                    submission_description='hi omg :)', latitude='24.580598568289673',
                                                    longitude='73.68247656513927')


        self.assertEqual(self.submission.submission_title, 'Yo this is my submission')
        self.assertEqual(self.submission.submission_visibility, 'Public')
        self.assertEqual(self.submission.submission_verification, 'Unverified')
        self.assertEqual(self.submission.submission_description, 'hi omg :)')
        self.assertEqual(self.submission.latitude, '24.580598568289673')
        self.assertEqual(self.submission.longitude, '73.68247656513927')
